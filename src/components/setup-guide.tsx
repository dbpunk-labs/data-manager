    ...
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div>
          ...
          <pre style={{ background: "lightgray", padding: "4px 8px" }}>
          ...
          <p>
            Note: curl and python3 are required in your environment For more
            info, please refer to <a>[link]</a>
          </p>
        </div>
      </div>
      <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div>
          ...
          <p>
            Check response, success example as below and you can visit console
            url in your browser to manage your database on DB3 node
          </p>
          <pre style={{ background: "lightgray", padding: "4px 8px" }}>
          ...
          <p>
            Note: if you have any problem, please refer to the <a>[doc]</a>
